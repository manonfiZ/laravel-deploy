    ...
    <section class="feature-section sec-pad">
        <div class="container">
            <div class="feature-title centered">
                <div class="section-title"><h2>Why The Biznes?</h2></div>
                    ...
                    <div class="call-back-content">
                        ...
                        <div class="form-area">
                            <form action="{{route('contact-post')}}" method="POST">
                                ...
                                <div class="button">
                                    <button type="submit" class="btn-one style-one radi">Envoyer</button>
                                </div>
                            </form>
                        </div>
                    </div>
